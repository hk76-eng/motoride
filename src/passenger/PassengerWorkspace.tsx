  ...
  const renderMap = (isFullBackground: boolean) => {
    ...
    return (
      <MotorideMap
        ...
        pickupDistanceText={effectiveKm > 0 ? `Trip: ${effectiveKm} km` : undefined}
    ...
    <div className="flex flex-col gap-4">
      {activeRide ? (
          ...
          <div className="bg-white rounded-3xl p-4 sm:p-5 flex flex-col gap-3.5 shadow-2xl text-black">
            ...
            {hasSelectedLocations && distanceKm > 0 && (
              <div className="flex items-center justify-between px-3.5 py-2.5 rounded-2xl bg-slate-950 text-white text-xs font-bold shadow-sm border border-emerald-500/40">
                <div className="flex items-center gap-2 min-w-0">
                  <span className="text-emerald-400 font-black flex items-center gap-1">
                    🛣️ Total Distance:
                  </span>
                  <span className="text-emerald-300 font-mono-num font-black text-sm">
                    {distanceKm} km
                  </span>
                  {durationMin > 0 && (
                ...
                <span className="px-2.5 py-1 rounded-lg bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-[10px] font-black uppercase tracking-wider shrink-0">
